...
import 'package:shaheendriver/features/uber_trip_feature/presentation/widgets/custom_elevated_button.dart';
                      ...
                      if (state is UserReqInitial) {
                            ...
                            message: 'No request available',
                              ...
                              itemBuilder: (context, index) {
                                return ListTile(
                                  ...
                                  leading: Text(
                                    '${state.tripHistoryList[index].tripHistoryModel.tripAmount} PKR',
                        ...
                        return Container(
                          ...
                          child: ListTile(
                              ...
                              leading: Text(
                                '${state.tripDriver.tripHistoryModel.tripAmount} PKR',
                                style: const TextStyle(
