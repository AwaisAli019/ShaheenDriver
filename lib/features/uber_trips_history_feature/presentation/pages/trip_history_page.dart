...
import 'package:shaheendriver/features/uber_trips_history_feature/presentation/widgets/message_display_widget.dart';
import 'package:shaheendriver/features/uber_trips_history_feature/presentation/widgets/trip_history_tile_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Your Trips", style: TextStyle(color: Colors.white),),
      ),
      body: Padding(
